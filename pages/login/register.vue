<template>
    <view>
		...
		<form class="form-login" @submit="formSubmit">
			...
			<view>
				<input id="userName" name="username" focus class="login-input" type="text" v-mode="userName" placeholder="请输入ID/手机号"/>
			...
			<view>
				...
				<image class="verif-code" src="../../static/verif-code.png" mode="widthFix" @tap="sendCode"></image>
			</view>
			<label for="">推荐人</label>
			<view>
				<input class="login-input" name="referrer" type="text" value="" placeholder="选填项"/>
			</view>
			<navigator url="login" class="go-login">已有账号去登录</navigator>
			<button form-type="submit" type="warn" class="login-btn">注册</button>
			<navigator url="" class="assent">注册即代表阅读并同意<text style="color: #e60012;">《服务条款》</text></navigator>
		</form>
	</view>
</template>
...
<script>
	...
	onLoad: function (option) { //option为object类型，会序列化上个页面传递的参数
        // console.log(option,123); //打印出上个页面传递的参数。
    },
    methods: {
        closeInput (e) {
